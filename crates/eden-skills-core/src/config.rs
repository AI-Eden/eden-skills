...
impl AgentKind {
    ...
    pub fn from_target_spec(spec: &str) -> Option<Self> {
        match spec {
            ...
            "iflow-cli" => Some(Self::IflowCli),
            "junie" => Some(Self::Junie),
            "kilo" => Some(Self::Kilo),
            "kimi-cli" => Some(Self::KimiCli),
            "kiro-cli" => Some(Self::KiroCli),
            "kode" => Some(Self::Kode),
            "mcpjam" => Some(Self::Mcpjam),
            "mistral-vibe" => Some(Self::MistralVibe),
            "mux" => Some(Self::Mux),
