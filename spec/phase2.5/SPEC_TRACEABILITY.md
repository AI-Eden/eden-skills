...
| TM-P25-041 | `SPEC_TEST_MATRIX.md` 8 | Default config parent auto-creation | `crates/eden-skills-cli/tests/install_url_tests.rs` (`install_default_config_path_auto_creates_missing_parent_directory`) | completed |
